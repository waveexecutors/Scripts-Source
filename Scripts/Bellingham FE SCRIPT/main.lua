...
local function performFootballSlide()
    ...
    -- Lower hip height for slide effect
...
print("📊 Block Speeds: Block 1=1s, Block 2=0.55s, Block 3=0.55s, Block 4=0.8s")
