...
mainFrame.Size = UDim2.new(0, 180, 0, 320) -- Expanded to fit new buttons
...
createButton("🚀 Toggle Speed Boost", function()
    ...
    if isSpeedBoost then
        hum.WalkSpeed = 65 -- Change to whatever speed you want
    else
...
delayInput.PlaceholderText = "Intro Speed (Default: 0.3s)"
delayInput.Text = ""
...
local function playIntro()
    ...
    task.spawn(function()
        ...
        -- Animation Sequence: Slide down based on introDelay variable
