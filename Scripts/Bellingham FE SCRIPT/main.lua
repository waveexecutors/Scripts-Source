...
local blockDelay = 0.8 -- Default delay between blocks (for blocks 2, 3, 4)
...
local function playIntro()
    ...
    -- Prevent multiple intros from playing at once
...
-- Create Replay Intro Button (after function is defined)
