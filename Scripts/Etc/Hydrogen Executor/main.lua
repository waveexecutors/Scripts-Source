...
ScreenGui.Name = "HydrogenMobileUI_Ultimate"
...
-- 1. Floating Toggle Icon (Mais largo/maior, com ícone de água menor dentro)
local ToggleButton = Instance.new("ImageButton")
ToggleButton.Name = "HydrogenToggle"
ToggleButton.Size = UDim2.new(0, 56, 0, 56) -- Maior para facilitar o toque no mobile
ToggleButton.Position = UDim2.new(0.05, 0, 0.2, 0)
ToggleButton.BackgroundColor3 = Color3.fromRGB(0, 0, 0) -- Fundo Preto Sólido
...
addConfigToggle("Unlock FPS (60 FPS)", false, function(state)
	if state then setfpslimit(60) createToast("FPS limited to 60") else setfpslimit(999) end
end)

addConfigToggle("Unlock FPS (120 FPS)", false, function(state)
	if state then setfpslimit(120) createToast("FPS limited to 120") else setfpslimit(999) end
end)
...
local themes = {
	Color3.fromRGB(35, 35, 35), -- Dark
	Color3.fromRGB(20, 20, 20), -- Pitch Black
	Color3.fromRGB(45, 25, 65), -- Purple
	Color3.fromRGB(65, 30, 30), -- Dark Red
	Color3.fromRGB(25, 55, 45)  -- Dark Green
}
...
-- 4. SAVES SCRIPTS PAGE (Salvar e Carregar Scripts Próprios)
local SavesPage = Instance.new("Frame")
...
SaveNameBox.BackgroundColor3 = Color3.fromRGB(100, 100, 100)
SaveNameBox.PlaceholderText = "Script Name..."
SaveNameBox.PlaceholderColor3 = Color3.fromRGB(200, 200, 200)
SaveNameBox.Text = ""
...
SaveCurrentBtn.BackgroundColor3 = Color3.fromRGB(50, 160, 90)
...
SavesScroll.BackgroundColor3 = Color3.fromRGB(120, 120, 120)
...
local function refreshSavesList()
	...
	SavesScroll.CanvasSize = UDim2.new(0, 0, 0, #savedScriptsTable * 38)
...
-- 5. ACCOUNT PAGE (Com Bloqueio de Nomes Proibidos: hydrogen, admin, etc.)
...
-- Lista de nomes proibidos/reservados
...
--- SIDEBAR NAVIGATION BUTTONS (Incluindo "Saves Scripts")
local navButtons = {
